...
public final class ChapterTableComponent extends VBox {
     ...
     *
     * @param values formatted chapter row labels
     */
     ...
     *
     * @param index selected chapter index
     */
    ...
    private final class ChapterRowCell extends ListCell<String> {
