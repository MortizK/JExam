...
- [x] Fix Difficulty Distribution für PDF Gen
  - [x] Silent Error oder Vereinfachung der Aktuellen Fehlermeldung
  - [x] Difficulty Distribution soll für die Ganze Klausur gelten, nicht nur pro Chapter
- [ ] Remove Custom Keyboard movement
- [x] Metriken
  - [x] Nicht nur Volumen Metriken
  - [x] Noch Kohäsion messen und hinzufügen
